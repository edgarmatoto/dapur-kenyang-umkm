...
class WebController extends Controller
{
    public function index(){
        return view('UserBlade.home', [
            'headerWebsite' => Cache::store("redis")->rememberForever('headerWebsite', function () {
                return HeaderWebsite::get()
            ...
            'kontak' => Cache::store("redis")->rememberForever('kontak', function () {
                return Kontak::get()
                    ->transform(fn($kontak) => [
                        'id' => $kontak->id,
            ...
            'tentangKami' => Cache::store("redis")->rememberForever('tentangKami', function () {
                return TentangKami::get()
            ...
            'testimoni' => Cache::store("redis")->rememberForever('testimoni', function () {
                return Testimoni::orderBy('nama')
                    ->get()
    ...
    public function produk(){
        return view('UserBlade.produk', [
            'produk' => Cache::store("redis")->rememberForever('produk', function () {
                return Produk::orderBy('nama_produk')
                    ->get()
                    ->transform(fn($produk) => [
                        'id_produk' => $produk->id_produk,
                        'nama_produk' => $produk->nama_produk,
